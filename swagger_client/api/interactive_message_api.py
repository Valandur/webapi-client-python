...
class InteractiveMessageApi(object):
    ...
    def get_message(self, uuid, **kwargs):  # noqa: E501
    ...
    def get_message_with_http_info(self, uuid, **kwargs):  # noqa: E501
        """Get a message  # noqa: E501
        ...
        if ('uuid' not in params or
                params['uuid'] is None):
            raise ValueError("Missing the required parameter `uuid` when calling `get_message`")  # noqa: E501
    ...
    def list_messages(self, **kwargs):  # noqa: E501
        ...
        :param str accept: Override the 'Accept' request header (useful for debugging your requests)
        :param bool pretty: Add to make the Web-API pretty print the response (useful for debugging your requests)
        :return: list[InteractiveMessage]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def list_messages_with_http_info(self, **kwargs):  # noqa: E501
        """List messages  # noqa: E501
