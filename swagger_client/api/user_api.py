...
class UserApi(object):
    ...
    def get_user_details(self, **kwargs):  # noqa: E501
        ...
        Checks to see if the passed api key is still valid and retrieves the user info and permissions associated with this key     **Required permissions:**    - **user.user**     # noqa: E501
    ...
    def logout(self, **kwargs):  # noqa: E501
        ...
        Invalidate the current API key, logging out the active user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
