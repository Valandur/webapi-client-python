...
class InfoApi(object):
    ...
    def get_info(self, **kwargs):
        ...
        if kwargs.get('callback'):
            return self.get_info_with_http_info(**kwargs)
        else:
            (data) = self.get_info_with_http_info(**kwargs)
            return data

    def get_info_with_http_info(self, **kwargs):
        """
        Server info
        Get general information about the minecraft server.  > Required permission: info.get 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_info_with_http_info(callback=callback_function)
    ...
    def get_server_properties(self, **kwargs):
        """
        Server properties
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_server_properties(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_server_properties_with_http_info(**kwargs)
        else:
            (data) = self.get_server_properties_with_http_info(**kwargs)
            return data

    def get_server_properties_with_http_info(self, **kwargs):
        """
        Server properties
        Get the main server properties (server.properties file)  > Required permission: properties.list 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_server_properties_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_server_properties" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/info/properties', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ServerPropertiesList',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_stats_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/info/stats', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
