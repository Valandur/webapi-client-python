...
class PluginApi(object):
    ...
    def get_plugin(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_plugin(id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str id: The id of the plugin to get detailed information about. (required)
        ...
        if kwargs.get('callback'):
            return self.get_plugin_with_http_info(id, **kwargs)
        else:
            (data) = self.get_plugin_with_http_info(id, **kwargs)
            return data

    def get_plugin_with_http_info(self, id, **kwargs):
        """
        Detailed plugin info
        Gets detailed information about a plugin.  > Required permission: plugin.one 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_plugin_with_http_info(id, callback=callback_function)
        ...
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_plugin`")
        ...
        return self.api_client.call_api('/plugin/{id}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_plugins_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/plugin', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
