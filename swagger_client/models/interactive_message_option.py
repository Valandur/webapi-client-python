...
class InteractiveMessageOption(object):
    ...
    def __init__(self, key=None, value=None):  # noqa: E501
        """InteractiveMessageOption - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InteractiveMessageOption, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InteractiveMessageOption):
            return False
