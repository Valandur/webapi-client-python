# swagger_client.EconomyApi

All URIs are relative to *https://localhost/api/v5*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_account**](EconomyApi.md#get_account) | **GET** /economy/account/{id} | List currencies
[**get_currencies**](EconomyApi.md#get_currencies) | **GET** /economy/currency | List currencies


# **get_account**
> Account get_account(id, details=details, accept=accept, pretty=pretty)
...
api_instance = swagger_client.EconomyApi(swagger_client.ApiClient(configuration))
id = 'id_example' # str | 
...
try:
    # List currencies
    api_response = api_instance.get_account(id, details=details, accept=accept, pretty=pretty)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling EconomyApi->get_account: %s\n" % e)
```
...
# **get_currencies**
> list[Currency] get_currencies(details=details, accept=accept, pretty=pretty)
...
try:
    # List currencies
    api_response = api_instance.get_currencies(details=details, accept=accept, pretty=pretty)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling EconomyApi->get_currencies: %s\n" % e)
```
