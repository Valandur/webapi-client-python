...
------------- | ------------- | -------------
[**list_properties**](ServerApi.md#list_properties) | **GET** /server/properties | List server properties
[**modify_properties**](ServerApi.md#modify_properties) | **PUT** /server/properties | Modify server properties
