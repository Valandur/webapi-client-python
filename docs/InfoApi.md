...
[**list_servlets**](InfoApi.md#list_servlets) | **GET** /info/servlets | List servlets


# **get_info**
> ServerInfo get_info(details=details, accept=accept, pretty=pretty)
...
try:
    # Server info
    api_response = api_instance.get_info(details=details, accept=accept, pretty=pretty)
    pprint(api_response)
...
# **get_stats**
> ServerStats get_stats(limit=limit, details=details, accept=accept, pretty=pretty)
...
try:
    # Server stats
    api_response = api_instance.get_stats(limit=limit, details=details, accept=accept, pretty=pretty)
    pprint(api_response)
except ApiException as e:
...
# **list_servlets**
> dict(str, str) list_servlets(details=details, accept=accept, pretty=pretty)
...
try:
    # List servlets
    api_response = api_instance.list_servlets(details=details, accept=accept, pretty=pretty)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling InfoApi->list_servlets: %s\n" % e)
```
